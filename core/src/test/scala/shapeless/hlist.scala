...
class HListTests {
  ...
  def testUnifier {
    ...
    Unifier[Apple :: HNil]
    Unifier[Fruit :: Pear :: HNil]
    Unifier[Apple :: Pear :: HNil]

    Unifier[Int :: String :: Int :: Int :: HNil]

    val uapap = Unifier[Apple :: Pear :: Apple :: Pear :: HNil]
    ...
    val u2 = (a :: HNil).unify
    typed[Apple :: HNil](u2)
    val u3 = (a :: a :: HNil).unify
    typed[Apple :: Apple :: HNil](u3)
    val u4 = (a :: a :: a :: HNil).unify
    typed[Apple :: Apple :: Apple :: HNil](u4)
    val u5 = (a :: a :: a :: a :: HNil).unify
    typed[Apple :: Apple :: Apple :: Apple :: HNil](u5)
    val u6 = (a :: p :: HNil).unify
    typed[Fruit :: Fruit :: HNil](u6)
    val u7 = (a :: f :: HNil).unify
    typed[Fruit :: Fruit :: HNil](u7)
    val u8 = (f :: a :: HNil).unify
    typed[Fruit :: Fruit :: HNil](u8)
    val u9a = (a :: f :: HNil).unify
    typed[Fruit :: Fruit :: HNil](u9a)
    val u9b = (a :: p :: HNil).unify
    typed[PWS :: PWS :: HNil](u9b)
    val u10 = apap.unify
    typed[PWS :: PWS :: PWS :: PWS :: HNil](u10)
    val u11 = apbp.unify
    typed[PWS :: PWS :: PWS :: PWS :: HNil](u11)
